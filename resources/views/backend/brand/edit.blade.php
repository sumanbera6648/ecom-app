...
@section('sub_breadcrumb','Edit Brand')
@section('main-content')
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
            <form id="work-platforms" class="section work-platforms" method="POST" action="" enctype="multipart/form-data">
                @csrf
                <div class="info">
                    <h5 class="mt-5">Edit Brand Table</h5>
                    <div class="row">
